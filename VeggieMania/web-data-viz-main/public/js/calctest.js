    ...
    for (let i = 0; i < checkboxes.length; i++) {
        if (checkboxes[i].checked) {
            ...
            if (quantidade >= 1) {
                ...
                carboidratol = Number(carboidrato[checkboxes[i].id] * quantidade).toFixed(2);// 27/06
                lipideosl = Number(lipideo[checkboxes[i].id] * quantidade).toFixed(2);// 27/06
                fibral = Number(fibraAlimentar[checkboxes[i].id] * quantidade).toFixed(2);// 27/06
                ...
                totalLipideos += Number(lipideosl);// 27/06
                ...
                texto += `<span>${nomel} - Calorias: ${calorial} |  Carboidratos:: ${carboidratol} |  Lipideos: ${lipideosl} |  Fibra alimentar: ${fibral} | Proteinas: ${proteinal} | Cálcio: ${calciol} | Ferro: ${ferrol} | Zinco: ${zincol}<br></span>`// 27/06
